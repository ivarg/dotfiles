...
" Most things here are shamelessly stolen from spf13-vim, as that was the
...
"
" Much of what you see here are copied verbatim from spf13. However, I expect
" that will gradually change, except perhaps for the comments.
...
" Define bundle groups for spf13 vim package
"let g:spf13_bundle_groups=['general', 'writing', 'neocomplcache', 'programming', 'go', 'ruby', 'python', 'javascript', 'html', 'misc',]
let g:spf13_bundle_groups=['go', 'haskell', 'general', 'programming']
...
" Plugins {
    ...
    " SnipMate {
        ...
        let g:snips_author = 'Ivar Gaitan <ivar.gaitan@gmail.com>'
    " }
